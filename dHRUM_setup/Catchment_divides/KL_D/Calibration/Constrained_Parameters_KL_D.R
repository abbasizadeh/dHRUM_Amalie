...
SlopeDist <- readRDS(file ="./Rscripts/dHRUM_setup/outputs/SlopeDist_KL_D_FG.rds")
...
CCB <- readRDS(file ="./Rscripts/dHRUM_setup/outputs/CCB_KL_D_FG.rds")
...
# Constraining RETCAP
SDC = readRDS(file = "./Rscripts/dHRUM_setup/outputs/SDC_KL_D_FG.rds")
