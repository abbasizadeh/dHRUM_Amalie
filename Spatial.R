...
SlopeR =terra::rast("D:/project/Aamlie_Paper/GIS/dem1.tif")
...
dtaDF_BP <- as.data.table(readRDS ("D:/project/Setups_For_Dist_Model/inputs/PT_intput_data/BP_D_FG_2021.rds"))
...
dtaDF_KL <- as.data.table(readRDS ("D:/project/Setups_For_Dist_Model/inputs/PT_intput_data/KL_D_FG_2021.rds"))
